...
/**
 * Print a formatted string to the screen, overwrite available for printing at
 * location too.
 *
 ...
 * number on which to print \param x The (x,y) coordinates of the top left
 * corner of the string \param y The (x,y) coordinates of the top left corner of
 * the string \param fmt  Format string \param ...  Optional list of arguments
